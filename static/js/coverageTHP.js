...
var markersTHP;  //declared outside function for use in layer control
window.addEventListener('DOMContentLoaded', init)
if (window.location.hash === "#cluster") {
	var markersTHP = new L.MarkerClusterGroup();  	// Set up cluster group
} else {
	var markersTHP = new L.LayerGroup();  	// Otherwise set up normal marker group
}
