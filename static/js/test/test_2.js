...
$.getJSON("static/data/results2008.json")
  .done(function(data) {
    //console.log(data);
    var info = processData(data);
    create2008PropSymbols(info.timestamps, data);
...
function create2008PropSymbols(timestamps, data) {
    results2008 = L.geoJson(data, {
...
function updatePropSymbols(timestamp) {
  results2008.eachLayer(function(layer) {
...
function roundNumber(inNumber) {
    ...
    $(legendColor).append('<h6><strong>Mohajote-Awami League ' + '<i class="circle" style="background:' + getColor(grades[0]) + '"></i></strong></h6>' +
